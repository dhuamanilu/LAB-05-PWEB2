...
from personas.views import (personaTestView, personaCreateView, personasDeleteView,
                         searchForHelp, personasAnotherCreateView , personaCreateVista,
                         personasShowObject, personasListView, personasDeleteView)
urlpatterns = [
